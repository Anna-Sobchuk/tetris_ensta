...
void Controller::defineTool(sf::RenderWindow & window) {
    ...
    m_statusBar[0].setFillColor(sf::Color::Blue);
    ...
    m_statusBar[1].setFillColor(sf::Color::Blue);
    ...
    m_statusBar[2].setFillColor(sf::Color::Blue);
...
void Controller::drawGetReady(sf::RenderWindow & window) {
    ...
    sf::Clock clock;
    clock.restart();
    m_getReady.setFillColor(sf::Color::Cyan);
...
void Controller::drawNextLevel(sf::RenderWindow & window) {
    ...
    sf::Clock clock;
    clock.restart();
    m_getReady.setFillColor(sf::Color::White);
    m_getReady.setCharacterSize(width / 10);
    m_getReady.setOutlineColor(sf::Color::Blue);
    m_getReady.setOutlineThickness(3);
    for (int i = 0; i < 3;) {
